...
namespace GCodeRobotCSharpEdition.Tamplates
{
    public class SendTampalte
    {
        ...
        public string is_start
        {
            get
            {
                return $"is_start${Is_start.ToString()}";
            }
            set
            {
                Is_start = Convert.ToBoolean(value);
            }
        }
        public string stop_after_layer
        {
            get
            {
                return $"stop_after_layer${Stop_after_layer.ToString()}";
            }
            set
            {
                Stop_after_layer = Convert.ToBoolean(value);
            }
        }
        ...
        public string is_continuous
        {
            get
            {
                return $"is_continuous${Is_continuous.ToString()}";
            }
            set
            {
                Is_continuous = Convert.ToBoolean(value);
            }
        }
        ...
        public string is_last_file
        {
            get
            {
                return $"is_last_file${Is_last_file.ToString()}";
            }
            set
            {
                Is_last_file = Convert.ToBoolean(value);
            }
        }
        ...
        public string next_file_path
        {
            get
            {
                return $"next_file_path${Next_file_path}";
            }
            set
            {
                Next_file_path = value;
            }
        }
        public string convertToString()
        {
            return current_file_path + ";" + is_start + ";" + stop_after_layer + ";" + is_continuous + ";" + is_last_file + ";" + next_file_path;
        }
